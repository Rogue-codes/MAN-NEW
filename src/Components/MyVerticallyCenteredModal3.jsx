      ...
      >
        <Modal.Body>
          <Row>
              ...
              <Col>
                  <h3 className='h3'>Rev. Isaac Adefemi Agoye</h3>
                  <p className='p'>National Treasurer</p><br />
                  <p className='p'>Director Friesland Food WAMCO Nig. Plc, 7B, ACME Road, Ikeja, Industrial Estate, Ogba, Ikeja.</p>
                  <Row>
